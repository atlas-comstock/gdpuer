...
define("MENU","description|菜单#title|功能向导@title|【校园资讯】- 回复数字或提示\n\n[1]广药新闻\t\t[2]就业信息\n[3]图书信息\t\t[4]还书\n[5]动漫更新\t\t[6]网络账号\n[7]查课表\t\t\t\t[8]发找找帮\n[9]勤管兼职\t\t[10]查成绩\n[11]查选修\t\t\t[cet]查四六级\n[开]开户指南\t\t[意见]小助手征集意见\t\t[报障]校园网故障查询#url|#pic@title|【生活服务】-
回复字母\n\n[A]听歌\t[B]公交\t[C]翻译\t[D]快递\n[E]解梦\t[F]手机\t[G]身份\t[H]音乐\n[T]天气#url|#pic@title|留言：*你的话\t聊天：任意回复#url|#pic@title|绑定：昵称XXX\t上不了校园网？回复：校园网故障查询 或者 报障 或者 114.w#url|#pic");
...
function reply_main($request, $w)
{
    ...
    if(!empty($content)){
        ...
        //动漫更新查询
            ...
            $content = "#title|校园网常见错误@title|查询校园网错误点此进入#url|http://av.jejeso.com/Ours/911/index.php#pic";
            if(strstr($content,'pic'))//多图文回复
            {
                $a=array();
                $b=array();
