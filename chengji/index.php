...
<head>
  <meta charset="utf-8">
  <title>学生成绩查询系统 By Yanson From OUR Studio</title>
  ...
  <!--[if lt IE 9]>
    <script src="chengji/js/html5shiv.js"></script>
  <![endif]-->
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="page-header">
				<h1>
				学生成绩查询系统 <span>By Yanson From OUR Studio</span>
				</h1>
			...
			<form class="form-inline" action="" method="post">
				...
				<div class="control-group">
					<div class="controls">
						...
						<a href="xuanxiu.php">点击进入查选修系统</a>
					</div>
				</div>
			</form>
		</div>
