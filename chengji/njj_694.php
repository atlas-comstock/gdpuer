<head>
  <meta charset="utf-8">
  <title>年级查询----学生选修查询系统 By Yanson From OUR Studio</title>
...
$count=mysql_query("select count(*) from `jwc_personinfo` WHERE `nj` = '{$nj_input}'"); //获得记录总数
...
if ($page != 1) { //页数不等于1
?>
<a href="njj_694.php?num=<?php echo $perNumber ;?>&nj_input=<?php echo $nj_input ;?>&page=<?php echo $page - 1;?>">上一页</a> <!--显示上一页-->
<?php
}
for ($i=1;$i<=$totalPage;$i++) {  //循环显示出页面
?>
<a href="njj_694.php?num=<?php echo $perNumber ;?>&nj_input=<?php echo $nj_input ;?>&page=<?php echo $i;?>"><?php echo $i ;?></a>
<?php
}
if ($page<$totalPage) { //如果page小于总页数,显示下一页链接
?>
<a href="njj_694.php?num=<?php echo $perNumber ;?>&nj_input=<?php echo $nj_input ;?>&page=<?php echo $page + 1;?>">下一页</a>
<?php
}
echo '<br><br><br>';


$sql_name = "SELECT * FROM `jwc_personinfo` WHERE `nj` = '{$nj_input}' limit $startCount,$perNumber";
