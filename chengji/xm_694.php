<head>
  <meta charset="utf-8">
  <title>姓名查询----学生选修查询系统 By Yanson From OUR Studio</title>
...
$count=mysql_query("select count(*) from `jwc_personinfo` WHERE `xm` like '%$nj_input%'"); //获得记录总数
...
$sql_name = "SELECT * FROM `jwc_personinfo` WHERE `xm` like '%$nj_input%' limit $startCount,$perNumber";
