<?php
$id = $_GET ['id'];
$html = file_get_contents ( 'http://www.gdpu.edu.cn/gdpunews/xw/ArticleShow.asp?ArticleID=' . $id );
...
<body id="news">
  ...
  <div class="Listpage">
    <div class="page-bizinfo">
      ...
      <div id="overlay"></div>
      <a id="biz-link" class="btn"
        onclick="dourl('http://www.xiaojo.com/myadmin/pages/home.php?user=ourstudio')"
        href="http://www.xiaojo.com/myadmin/pages/home.php?user=ourstudio">
        <div class="arrow">
        ...
        <div class="logo">
          ...
          <img id="img"
            src="http://www.xiaojo.com/upload/13/04/20/136643284510750.jpg                       "
            border=0 width="100" height="100">
        </div>
        <div id="nickname">{$gdpuer}</div>
