...
/*
 * 处理成微信图文数据,数组形式 $format = array("title","#description","#pic","#url","@title|"); $format=implode("|",$format); preg_match_all('/\D\w+[|]/', $format, $formats); Array ( [0] => Array ( [0] => title| [1] => #description| [2] => #pic| [3] => #url| [4] => @title| ) )
 */
?>